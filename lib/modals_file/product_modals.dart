...
List<FinishedProduct> finishedProductFromJson(String str) => 
    List<FinishedProduct>.from(json.decode(str).map((x) => FinishedProduct.fromJson(x)));

String finishedProductToJson(List<FinishedProduct> data) => 
...
class FinishedProduct {
  ...
  factory FinishedProduct.fromJson(Map<String, dynamic> json) => FinishedProduct(
    ...
    itemModels: json["itemModels"] != null
      ? List<ItemModelProduct>.from(json["itemModels"].map((x) => ItemModelProduct.fromJson(x)))
      : [],
    v: json["__v"] ?? 0,
  );
...
class ItemModelProduct {
  ...
  factory ItemModelProduct.fromJson(Map<String, dynamic> json) => ItemModelProduct(
    ...
    summaSebestoimostPrice: json["summaSebestoimostPrice"] ?? 0,
    summaProdazhaPrice: json["summaProdazhaPrice"] ?? 0,
    productAllQuantity: json["productAllQuantity"] ?? 0,
    ...
    sizeVariations: json["sizeVariations"] != null
      ? List<SizeVariationProduct>.from(json["sizeVariations"].map((x) => SizeVariationProduct.fromJson(x)))
      : [],
    id: json["_id"] ?? '',
  );
...
class SizeVariationProduct {
  ...
  factory SizeVariationProduct.fromJson(Map<String, dynamic> json) => SizeVariationProduct(
    size: json["size"] ?? '',
    costSebestoimostPrice: json["costSebestoimostPrice"] ?? 0,
    costProdazhaPrice: json["costProdazhaPrice"] ?? 0,
    codeitem: json["codeitem"] ?? '',
    productSizeComment: json["productSizeComment"] ?? '',
    productSizeQuantity: json["productSizeQuantity"] ?? 0,
